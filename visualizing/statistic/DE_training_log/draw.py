...
def run():
    ...
    plt.plot(x1, intercept1 + slope1 * x1, 'r', label="linear regression")
    plt.plot(x2, intercept2+ slope2 * x2, 'g', label="linear regression")
    plt.plot(x3, intercept3+ slope3 * x3, 'b', label="linear regression")
    plt.legend()
    plt.title("training log (Moving Average & linearRegression)")
    plt.xlabel("Index")
    plt.ylabel("Value")
    ...
    plt.plot(x4, intercept4 + slope4 * x4, 'r', label="linear regression")
    plt.plot(x5, intercept5 + slope5 * x5, 'g', label="linear regression")
    plt.plot(x6, intercept6 + slope6 * x6, 'b', label="linear regression")
    plt.legend()
    plt.title("training log (Moving Average & linearRegression)")
    plt.xlabel("Index")
    plt.ylabel("Value")
